...
function Layout() {
  return (
    <div className="min-h-screen bg-[#10100f] text-zinc-100">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#10100f]/88 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <NavLink to="/" className="flex items-center gap-3">
            <span className="grid h-11 w-11 place-items-center rounded-md border border-amber-300/30 bg-amber-300/10 text-lg font-black text-amber-200">
              10
            </span>
